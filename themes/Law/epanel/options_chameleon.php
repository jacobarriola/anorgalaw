...
$et_google_fonts = apply_filters( 'et_google_fonts', array(' Times New Roman','Droid Sans',' Times New Roman','Lobster','Yanone Kaffeesatz','Nobile','Crimson Text','Arvo','Tangerine','Cuprum','Questrial','Cantarell','Philosopher','Josefin Sans','Dancing Script','Raleway','Bentham','Goudy Bookletter 1911','Quattrocento','Ubuntu', 'PT Sans') );
