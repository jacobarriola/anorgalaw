				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<?php /*?>	<?php $thumb = '';
						...
						<?php if (!$et_ptemplate_blogstyle) { ?>
							...
							<a href="<?php the_permalink(); ?>" class="readmore2" style="color:#000;"><span><?php esc_html_e('read more','Chameleon'); ?></span></a>
						<?php } else { ?>
							<?php
								global $more;
								$more = 0;
